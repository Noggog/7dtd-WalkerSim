...
namespace WalkerSim
{
    ...
    public class WorldZoneManager : ZoneManager<WorldZone>
    {
        ...
        public void BuildZones(Vector3i worldMins, Vector3i worldMaxs)
        {
            ...
            int zoneSizeX = lenX / Config.Instance.WorldZoneDivider;
            int zoneSizeY = lenY / Config.Instance.WorldZoneDivider;
